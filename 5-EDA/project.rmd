...
Next, we further grasp the whole using pair plot.
Let's see details based on these results.
...
ggplot(data,aes(x=volatile.acidity,fill=factor(good.wine)))+geom_density(alpha=0.25)+
...
ggplot(data,aes(x=citric.acid,fill=factor(good.wine)))+geom_density(alpha=0.25)+
...
ggplot(data,aes(x=alcohol,fill=factor(good.wine)))+geom_density(alpha=0.25)+
